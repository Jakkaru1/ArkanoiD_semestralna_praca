...
/**
 * Trieda Obrazok, reprezentuje bitmapovy obrazok, ktory moze byt vykresleny na
 * platno.
 *
...
public class Obrazok {
    ...
    protected double uhol;

    private BufferedImage obrazok;

    /**
     * Parametricky konstruktor vytvori Obrazok na pozicii paX, paY s natocenim
     * paUhol
     *
     ...
     * @param stredY
     */
    public void zmenSuradnice(int stredX, int stredY) {
        boolean nakresleny = this.jeViditelny;
        this.zmaz();
        this.lavyHornyX = stredX;
        this.lavyHornyY = stredY;
        if (nakresleny) {
            this.nakresli();
        }
    }
    ...
    /**
     * (Obrázok) Zmení obrázok. Súbor s obrázkom musí existovať.
     *
